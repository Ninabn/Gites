...
<div class="flex justify-end m-5">
		<button class='bg-blue-500 text-white p-2 rounded text-xl font-bold mr-5 hover:bg-blue-400'>Créez un compte</button>
		<button onclick="openModal()" class='bg-blue-500 text-white p-2 rounded text-xl font-bold hover:bg-blue-400'>Se connecter</button>
		<i class="fa fa-user fa-3x pl-5" aria-hidden="true"></i>
</div>
		...
		<div
			...
			<div class="modal-content py-4 text-left px-6">
				...
				<div class="flex justify-between items-center pb-3">
					<p class="text-2xl font-bold">Connexion à votre compte</p>
				...
				<div class="flex justify-end pt-2">
                        <button class="focus:outline-none modal-close px-4 bg-gray-400 p-3 rounded-lg text-black hover:bg-gray-300">Quitter</button>
...
<nav
        ...
        <div class="flex justify-between lg:w-auto w-full lg:border-b-0 pl-6 pr-2 border-solid border-b-2 border-gray-300 pb-5 lg:pb-0">
            <div class="flex items-center flex-shrink-0 text-gray-800 mr-16">
                <span class="font-semibold text-2xl tracking-tight">Gites</span>
            </div>
            ...
            <div class="flex ">
                <a href="#"
                   class="block text-md px-4 py-2 rounded text-blue-700 ml-2 font-bold hover:text-white mt-4 hover:bg-blue-700 lg:mt-0">Créez un compte</a>
  ...
  <div class="w-full text-gray-700 bg-white dark-mode:text-gray-200 dark-mode:bg-gray-800">
    <div x-data="{ open: true}" class="flex flex-col max-w-screen-xl px-4 mx-auto md:items-center md:justify-between md:flex-row md:px-6 lg:px-8">
      <div class="flex flex-row items-center justify-between p-4">
        <a href="#" class="text-lg font-semibold tracking-widest text-gray-900 uppercase rounded-lg dark-mode:text-white focus:outline-none focus:shadow-outline">Gites</a>
